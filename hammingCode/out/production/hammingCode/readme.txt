Two java files
1.HammingCode.java - this file is the logic of the hamming code generator. No GUI, and use even parity only

2. hammingCodeGenerator.java - this file is the final code contain GUI. And user in able to chose even or odd parity
